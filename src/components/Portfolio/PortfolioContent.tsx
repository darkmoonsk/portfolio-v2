      ...
      >
        <div className="h-full w-full flex flex-col gap-5 justify-center m-auto text-center sm:text-start">
          ...
          >
            ...
            <h1
              className="welcome-text text-base md:text-lg font-semibold"
              id="about-me"
            >
              Fullstack Developer
            </h1>
          ...
          >
            I am {currentYear - 1997} years old and a Software Engineer with{" "}
            {currentYear - 2019} years of experience working in Fullstack
            development using{" "}
            <Text tag="span" theme="default">
              React, JavaScript, TypeScript, Next, and Node.
            </Text>
          </motion.p>
          <motion.a
