...
function Modal({ onClose }: ModalProps) {
  return (
    <>
    <div onClick={onClose} className="fixed w-full h-full bg-black/40 z-40"></div>
    <div
      className="
    w-full max-w-[800px] max-h-[500px] overflow-y-scroll fixed left-1/2 top-[55%] -translate-x-1/2 -translate-y-1/2 shadow-lg shadow-[#2A0E61]/50
    bg-[#03001417] backdrop-blur-md z-50 px-10 mx-3 text-white flex flex-col gap-2 p-4
    "
    >
      <div>
